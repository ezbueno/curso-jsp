		...
		<tbody>
			<c:forEach items="${telefones}" var="fone">
				<tr>
					...
					<td><a href="salvarTelefone?acao=deleteFone&foneId=${fone.id}"><img alt="Excluir" src="resources/img/excluir.png" title="Excluir" width="20px" height="20px" onclick=" return confirm('Deseja realizar a exclusão?')"></a></td>	
				</tr>				
			</c:forEach>
	</table>	
		<script type="text/javascript">
